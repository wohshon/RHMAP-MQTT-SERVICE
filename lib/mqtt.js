...
var amqHost= process.env.AMQ_HOST || 'broker-amq-mqtt-ssl-xpaas-amq.cloudapps.demo.com';
var amqPort= process.env.AMQ_PORT || 443;
var amqProtocol= process.env.AMQ_PROTOCOL || "mqtts://";
var amqUsername= process.env.AMQ_USERNAME || 'admin';
var amqPassword= process.env.AMQ_PASSWORD || 'admin';
var passphasePassword='password';
var topic= process.env.AMQ_TOPIC || "my.topic";
var options={
  host: amqHost,
  port: amqPort,
  key:key,
...
mqtt.post('/pub', function(req, res) {
    ...
    client.publish(topic, (req.body.clientId+' sent : '+req.body.amqMsg));
